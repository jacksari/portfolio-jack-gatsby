          ...
          <div className="flex items-center justify-center">
            <form action="https://formspree.io/f/mlezjagg" method="POST" className="w-96 bg-white p-4 md:p-8 rounded-md">
              ...
              <div className="flex flex-col items-start mb-2">
                ...
                <input type="email" name="_replyto" className="w-full bg-primary-100 px-4 py-2 rounded mt-2 outline-none" type="text" placeholder="Your email" />
              </div>
              <div className="flex flex-col items-start mb-2">
                <label className="text-gray-700 font-semibold">Message:</label>
                <textarea name="message" className="w-full bg-primary-100 px-4 py-2 rounded mt-2 outline-none h-20" placeholder="Your message" />
              </div>
              <div className="flex flex-col items-start mb-2">
